      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-8 pb-20">
        ...
        {query && (
          <section className="mt-10 scroll-mt-20" id="searchResults">
            ...
            <div className="bg-white p-3 md:p-4 rounded-xl md:rounded-2xl border border-gray-100 shadow-sm mb-6 flex flex-wrap items-center gap-3">
              <div className="flex items-center gap-2 px-2.5 py-1.5 md:px-3 md:py-2 bg-gray-50 rounded-lg border border-gray-200 flex-1 min-w-[140px]">
                <span className="text-xs md:text-sm font-bold text-gray-500"><DollarSign size={14} className="inline" /> ราคา:</span>
                <input
                  type="number"
                  placeholder="ต่ำ"
                  className="w-12 md:w-16 bg-transparent text-xs md:text-sm focus:outline-none placeholder-gray-400"
              ...
              <div className="flex items-center gap-2 px-2.5 py-1.5 md:px-3 md:py-2 bg-gray-50 rounded-lg border border-gray-200 flex-1 min-w-[140px]">
                ...
                <input
                  ...
                  className="w-full bg-transparent text-xs md:text-sm focus:outline-none placeholder-gray-400"
              ...
              <div className="flex items-center gap-2 px-2.5 py-1.5 md:px-3 md:py-2 bg-gray-50 rounded-lg border border-gray-200 flex-1 min-w-[140px]">
                ...
                <select
                  className="w-full bg-transparent text-xs md:text-sm focus:outline-none cursor-pointer text-gray-600"
              ...
              <select
                className="px-2.5 py-1.5 md:px-3 md:py-2 bg-gray-50 rounded-lg border border-gray-200 text-xs md:text-sm focus:outline-none cursor-pointer text-gray-600 flex-1 min-w-[140px]"
                value={filters.rating}
                onChange={(e) => handleFilterChange('rating', e.target.value)}
              >
                <option value="">ทั้งหมด (ดาว)</option>
        ...
        <div className="pt-8 pb-10">
          <div className="relative bg-white rounded-[2rem] shadow-xl p-8 md:p-12 overflow-hidden min-h-[300px] flex items-center justify-between gap-8 border border-gray-100">
            ...
            <div className="relative z-10 hidden lg:flex flex-1 min-w-[320px] max-w-[430px] items-center justify-center self-stretch">
              <div className="w-full overflow-hidden rounded-[1.75rem] border border-indigo-100/80 bg-white shadow-[0_18px_40px_rgba(79,70,229,0.12)]">
                <img
                  src="/tutor_home_pic_hero.jpg"
                  alt="Tutor hero visual"
                  loading="eager"
                  fetchPriority="high"
                  decoding="async"
                  width="1400"
